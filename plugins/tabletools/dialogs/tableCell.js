...
CKEDITOR.dialog.add( 'cellProperties', function( editor ) {
	...
	return {
		...
		minWidth: CKEDITOR.env.ie && CKEDITOR.env.version < 11 && CKEDITOR.env.quirks ? 450 : 410,
		minHeight: CKEDITOR.env.ie && CKEDITOR.env.version < 11 && ( CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks ) ? 230 : 220,
		contents: [
			{
			id: 'info',
