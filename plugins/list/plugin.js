		...
		arrayToList: function( listArray, database, baseIndex, paragraphMode, dir ) {
			...
			while ( 1 ) {
				...
				if ( item.indent == indentLevel ) {
					...
					if ( !currentListItem.getChildCount() && CKEDITOR.env.ie && CKEDITOR.env.version < 11 && !( doc.$.documentMode > 7 ) )
					...
					if ( !( CKEDITOR.env.ie && CKEDITOR.env.version < 11 ) && ( currentListItemName == 'div' || currentListItemName == 'p' ) )
